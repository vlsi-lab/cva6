#!/usr/bin/env bash
# Out-of-context Vivado synthesis driver for vrf_synth_top (CVA6 core +
# vrf_ip accelerator). No CW305 pins, no bitstream -- see
# ../../../IMPLEMENTATION.md.
#
...
echo "[run_synth] vrf_synth_top: CVA6 + vrf_ip (part=${XILINX_PART}, clk=${CLK_PERIOD_NS}ns)"
...
echo "[run_synth] Area summary: run scripts/report_area.py to extract the breakdown"