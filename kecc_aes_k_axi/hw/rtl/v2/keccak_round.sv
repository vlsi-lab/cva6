...
//                                                                                      //
// Derived from cva6-keccak-loosely/keccak_ip's keccak_round.sv (Josh Moles, MIT        //
// license, http://keccak.noekeon.org/ VHDL translation) -- theta/rho/pi/chi are         //
// unchanged; iota is optimized here to take an 8-bit Round_constant_signal instead of   //
// 64, XORing only the 8 bit positions {0,1,2,3,7,15,31,63} of lane (0,0) that could      //
// ever be nonzero (bit 2 is always 0, kept only for byte alignment -- see               //
// keccak_round_constants_gen.sv) instead of a 64-way XOR against a signal that's zero    //
// almost everywhere.                                                                    //
//                                                                                      //
//////////////////////////////////////////////////////////////////////////////////////////
...
// Only 8 of lane (0,0)'s 64 bits can ever be nonzero in a real round constant
// (see keccak_round_constants_gen.sv) -- default-copy the lane, then override
// just those 8 bit positions instead of a 64-way XOR against a signal that's
