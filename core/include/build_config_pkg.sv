package build_config_pkg;
  ...
  function automatic config_pkg::cva6_cfg_t build_config(config_pkg::cva6_user_cfg_t CVA6Cfg);
    ...
    cfg.LooseAesEn = CVA6Cfg.LooseAesEn;
    cfg.LooseAesVersion = CVA6Cfg.LooseAesVersion;
    cfg.LooseAesSboxImpl = CVA6Cfg.LooseAesSboxImpl;
    cfg.LooseAesParallelSlices = CVA6Cfg.LooseAesParallelSlices;
