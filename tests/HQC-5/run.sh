...
python3 cva6.py --target=$DV_TARGET --iss=$DV_SIMULATORS --iss_yaml=cva6.yaml \
    ...
    ../../tests/HQC-5/code.c \
    ../../tests/HQC-5/crypto_memset.c \
    ../../tests/HQC-5/fft.c \
    ../../tests/HQC-5/fips202.c \
    ../../tests/HQC-5/gf.c \
    ../../tests/HQC-5/gf2x.c \
    ../../tests/HQC-5/hqc.c \
    ../../tests/HQC-5/kem.c \
    ../../tests/HQC-5/parsing.c \
    ../../tests/HQC-5/reed_muller.c \
    ../../tests/HQC-5/reed_solomon.c \
    ../../tests/HQC-5/symmetric.c \
    ../../tests/HQC-5/vector.c \
    -lgcc -fstack-usage\
    -I../tests/custom/env -I../tests/custom/common -I../../tests/HQC-5"
