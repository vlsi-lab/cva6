...
# ****************************************************************************
#
# Desc: Run the "ntt" SW-vs-HW microbenchmark on the CVA6 simulator.
#       Compares Falcon's software forward NTT (mod 12289, n=512) against
#       the vrf_ip AXI accelerator's ntt_engine.sv offload
#       (mq_NTT_hw()/fmp_NTT_hw(), extracted from
...
# ---- Source files -------------------------------------------------------
src_main=../../tests/app-tests/ntt/ntt.c
