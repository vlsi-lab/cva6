#!/bin/bash
# =============================================================================
# Per-test runner for "thash-wots" (WOTS+ hash-chain SW-vs-HW via
# chain_job_ctrl's steps_q/step_start_q multi-step THASH1 mechanism).
#
# Same cva6.py / veri-testharness invocation pattern used by every other
# tests/app-tests/*/run.sh.
#
# Run from the cva6 repo root:
#     bash tests/app-tests/thash-wots/run.sh
# =============================================================================
...
python3 cva6.py \
    ...
    --iss="$DV_SIMULATORS" \
    --iss_yaml=cva6.yaml \
    --c_tests ../../tests/app-tests/thash-wots/main.c \
