#!/bin/bash
# =============================================================================
# Per-test runner for "chain-lengths".
#
...
src_main=../../tests/chain-lengths/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../tests/chain-lengths/chain_lengths_sw.c
)
