...
typedef struct {
  ...
  uint8_t witness[2688 / 8];
} faest_em_256s_unpacked_private_key_t;
 ...
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_em_256s_unpack_private_key(faest_em_256s_unpacked_private_key_t* unpacked_sk, const uint8_t* sk);
 ...
 * bytes required for a parameter set is given by FAEST_EM_256S_SIGNATURE_SIZE.
 ...
 * @return Returns 0 for success, or a nonzero value indicating an error.
 *
 * @see faest_em_256s_verify(), faest_em_256s_keygen()
 */
 ...
 * @return Returns 0 for success, or a nonzero value indicating an error.
 *
 * @see faest_em_256s_verify(), faest_em_256s_keygen(), faest_em_256s_unpack_private_key()
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_em_256s_unpacked_sign(const faest_em_256s_unpacked_private_key_t* unpacked_sk, const uint8_t* message, size_t message_len, uint8_t* signature, size_t* signature_len);
 ...
 * @see faest_em_256s_verify(), faest_em_256s_keygen(), faest_em_256s_unpack_private_key()
 */
FAEST_EXPORT int FAEST_CALLING_CONVENTION faest_em_256s_unpacked_sign_with_randomness(const faest_em_256s_unpacked_private_key_t* unpacked_sk, const uint8_t* message, size_t message_len, const uint8_t* rho, size_t rho_len, uint8_t* signature, size_t* signature_len);
 ...
 *
 * @see faest_em_256s_sign(), faest_em_256s_keygen()
 */
 ...
 */
FAEST_EXPORT void FAEST_CALLING_CONVENTION faest_em_256s_clear_unpacked_private_key(faest_em_256s_unpacked_private_key_t* unpacked_sk);
