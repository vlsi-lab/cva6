...
// Added beyond the original ml-kem-512 fips202.c: finalize with an explicit
// domain-separation byte, needed for cSHAKE256/KMAC256 (domain 0x04) since
// plain shake256_finalize() hardcodes SHAKE's 0x1F.
#define shake256_finalize_domain FIPS202_NAMESPACE(shake256_finalize_domain)
