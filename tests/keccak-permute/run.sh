#!/bin/bash
# =============================================================================
# Per-test runner for "keccak-permute".
#
...
src_main=../../tests/keccak-permute/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../tests/keccak-permute/hash_coproc.S
)
