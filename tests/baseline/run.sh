...
echo ""
echo "Available baseline folders:"
...
# Include directory: prefer selected_folder/include, otherwise baseline/include, otherwise nothing
EXTRA_INCLUDE=""
if [[ -d "../../${SELECTED_DIR#./}/include" ]]; then
    EXTRA_INCLUDE="-I../../${SELECTED_DIR#./}/include"
elif [[ -d "../../tests/baseline/include" ]]; then
    EXTRA_INCLUDE="-I../../tests/baseline/include"
fi
