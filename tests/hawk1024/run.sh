...
# ---- Source files -------------------------------------------------------
src_main=../../tests/hawk1024/main.c

src_incs=(
    # HAWK core implementation
    ../../tests/hawk1024/hawk_kgen.c
    ../../tests/hawk1024/hawk_sign.c
    ../../tests/hawk1024/hawk_vrfy.c
    # NTT / polynomial helpers
    ../../tests/hawk1024/ng_fxp.c
    ../../tests/hawk1024/ng_hawk.c
    ../../tests/hawk1024/ng_mp31.c
    ../../tests/hawk1024/ng_ntru.c
    ../../tests/hawk1024/ng_poly.c
    ../../tests/hawk1024/ng_zint31.c
    # SHA-3 / SHAKE
    ../../tests/hawk1024/sha3.c
    # NIST API wrapper (keygen / sign / verify) for HAWK-1024 (logn=10)
    ../../tests/hawk1024/api.c
    # NIST AES-256-CTR DRBG (pure-C, no OpenSSL dependency)
    ../../tests/hawk1024/rng.c
...
cflags=(
    ...
    -I../../tests/hawk1024     # api.h, test_vectors_1024.h, hawk headers
)
