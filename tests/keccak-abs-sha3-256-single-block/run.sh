#!/bin/bash
# =============================================================================
# Per-test runner for "keccak-abs-sha3-256-single-block".
#
...
TEST_NAME="keccak-abs-sha3-256-single-block"
...
src_main=../../tests/keccak-abs-sha3-256-single-block/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../tests/keccak-abs-sha3-256-single-block/fips202.c
    ../../tests/keccak-abs-sha3-256-single-block/fips202_hw.c
    ../../tests/keccak-abs-sha3-256-single-block/hash_coproc.S
)
...
cflags=(
    ...
    -I../../tests/keccak-abs-sha3-256-single-block
    -I../../tests/inc
    -I../../tests
)
