...
int main(void)
{
    ...
    //*************************************************
        ...
        memcpy(keypair_rnd, TVEC_IN_SIGN_KEYPAIR[i], 48);
    ...
    //*************************************************
        ...
        if(memcmp(sm, TVEC_IN_SM_SIGN[i], CRYPTO_BYTES)) { printf("ERROR: SM mismatch\n"); return -1;}
    ...
    //*************************************************
        ...
        #if TEST_SIGN == 0
          memcpy(sm, TVEC_IN_SM_SIGN[i], 691);
        #endif /* TEST_SIGN */
        ...
        crypto_sign_open(m1, &mlen1, sm, 691, pk);
