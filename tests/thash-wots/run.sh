#!/bin/bash
# =============================================================================
# Per-test runner for "thash-wots".
#
...
src_main=../../tests/thash-wots/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../tests/thash-wots/hash_coproc.S
    ../../tests/thash-wots/thash_hw.c
    ../../tests/thash-wots/thash_sw.c
    ../../tests/thash-wots/wots_chain_hw.c
    ../../tests/thash-wots/wots_chain_sw.c
)
