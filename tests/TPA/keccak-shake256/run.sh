#!/bin/bash
#
# Builds and runs the Keccak-f[1600] TPA benchmark for SHAKE256 (r=1088 bits)
# on the cva6 RTL simulator. Prints the permutation cycle count (C_perm)
# needed for TPA = r * f_clk / (C_perm * A).
#
# Usage:
#   tests/TPA/keccak-shake256/run.sh          # original: pure-software permutation
#   tests/TPA/keccak-shake256/run.sh copro    # optimized: Keccak AXI accelerator IP
...
src_main=../../tests/TPA/keccak-shake256/main.c
