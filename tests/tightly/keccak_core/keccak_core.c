// Keccak-f[1600] permutation core benchmark, coprocessor-accelerated.
// Adapted from tests/keccak64/keccak_full.c (same KAT vector, same xor5/
// xandn/rxri macros from keccak_copro.h), extended with instruction counting
// alongside the existing cycle counting.

#include "uart.h"
#include "encoding.h"
#include "bench.h"
#include "keccak_copro.h"
...
int main(){
    ...
    printf("Keccak-f[1600] Permutation Core Benchmark - Tightly (coprocessor)\n");
