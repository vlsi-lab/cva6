...
#       falcon512_baseline.c, trimmed to verify-only.
#
# ****************************************************************************
...
# ---- Source files -------------------------------------------------------
src_main=../../tests/vrf/baseline/falcon512/falcon512_baseline.c

src_incs=(
    # Falcon-512 reference implementation
    ../../tests/vrf/baseline/falcon512/codec.c
    ../../tests/vrf/baseline/falcon512/common.c
    ../../tests/vrf/baseline/falcon512/fft.c
    ../../tests/vrf/baseline/falcon512/fpr.c
    ../../tests/vrf/baseline/falcon512/keygen.c
    ../../tests/vrf/baseline/falcon512/nist.c
    ../../tests/vrf/baseline/falcon512/rng.c
    ../../tests/vrf/baseline/falcon512/shake.c
    ../../tests/vrf/baseline/falcon512/sign.c
    ../../tests/vrf/baseline/falcon512/vrfy.c
)
...
cflags=(
    ...
    -I../../tests/vrf/baseline/falcon512     # api.h, uart.h, test_vectors_512.h, inner.h, fpr.h
)
