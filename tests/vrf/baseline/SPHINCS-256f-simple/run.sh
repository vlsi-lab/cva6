...
TEST_NAME="SLH-DSA-baseline-SPHINCS-256f-simple"
...
TEST_DIR=../../tests/vrf/baseline/SPHINCS-256f-simple
...
src_main="$TEST_DIR/SPHINCS-256f-simple_baseline.c"
