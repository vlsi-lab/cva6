///////////////////////////////////////////////////////////////////////////////////////
// Bare-metal CVA6 verify-only KAT test for falcon-1024, trimmed from the
// auto-generated static test (tools/gen_static_test.py output). vrf_ip is a
// verify-only accelerator, so this harness only exercises crypto_sign_open()
// -- keygen/sign are not run here (see tests/pqc/ for the full
// keygen+sign+verify baseline/optimized harness). The KAT's own pk/sm
// values are loaded directly instead of generating them. stdio's printf
// replaced with the simulated UART (print_uart/print_uart_dec); cycle
// counting via the RISC-V mcycle CSR, retired-instruction counting via
// minstret (encoding.h), same pattern as every other test in this repo.
///////////////////////////////////////////////////////////////////////////////////////
