#!/bin/bash
# =============================================================================
# Per-test runner for ML-DSA-44 (Dilithium2) baseline test.
# =============================================================================
: "${LD_LIBRARY_PATH:=}"; export LD_LIBRARY_PATH

THIS_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
TEST_NAME="ML-DSA-baseline-ML-DSA-44"
...
TEST_DIR=../../tests/vrf/optimized/ML-DSA-44

src_main="$TEST_DIR/ML-DSA-44_optimized.c"
