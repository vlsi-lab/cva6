...
#       falcon1024_optimized.c, trimmed to verify-only.
...
# ---- Source files -------------------------------------------------------
src_main=../../tests/vrf/optimized/falcon1024/falcon1024_optimized.c

src_incs=(
    # Falcon-1024 reference implementation
    ../../tests/vrf/optimized/falcon1024/codec.c
    ../../tests/vrf/optimized/falcon1024/common.c
    ../../tests/vrf/optimized/falcon1024/fft.c
    ../../tests/vrf/optimized/falcon1024/fpr.c
    ../../tests/vrf/optimized/falcon1024/keygen.c
    ../../tests/vrf/optimized/falcon1024/nist.c
    ../../tests/vrf/optimized/falcon1024/rng.c
    # SHA-3 / SHAKE256 (process_block offloaded to the vrf_ip Keccak AXI accelerator)
    ../../tests/vrf/optimized/falcon1024/shake.c
    ../../tests/vrf/optimized/falcon1024/sign.c
    ../../tests/vrf/optimized/falcon1024/vrfy.c
)
...
cflags=(
    ...
    -I../../tests/vrf/optimized/falcon1024 # api.h, uart.h, test_vectors_1024.h, inner.h, fpr.h
