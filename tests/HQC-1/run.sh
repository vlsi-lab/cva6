...
python3 cva6.py --target=$DV_TARGET --iss=$DV_SIMULATORS --iss_yaml=cva6.yaml \
    ...
    ../../tests/HQC-1/code.c \
    ../../tests/HQC-1/crypto_memset.c \
    ../../tests/HQC-1/fft.c \
    ../../tests/HQC-1/fips202.c \
    ../../tests/HQC-1/gf.c \
    ../../tests/HQC-1/gf2x.c \
    ../../tests/HQC-1/hqc.c \
    ../../tests/HQC-1/kem.c \
    ../../tests/HQC-1/parsing.c \
    ../../tests/HQC-1/reed_muller.c \
    ../../tests/HQC-1/reed_solomon.c \
    ../../tests/HQC-1/symmetric.c \
    ../../tests/HQC-1/vector.c \
    -lgcc -fstack-usage\
    -I../tests/custom/env -I../tests/custom/common -I../../tests/HQC-1"
