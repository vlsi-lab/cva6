...
# Date: June 2025
# Desc: Run HAWK-256 KAT + cycle profiling on the CVA6 simulator.
...
# ---- Source files -------------------------------------------------------
src_main=../../tests/hawk-256-profiling/main.c

src_incs=(
    # HAWK core implementation (profiling-instrumented copies)
    ../../tests/hawk-256-profiling/hawk_kgen.c
    ../../tests/hawk-256-profiling/hawk_sign.c
    ../../tests/hawk-256-profiling/hawk_vrfy.c
    # NTT / polynomial helpers
    ../../tests/hawk-256-profiling/ng_fxp.c
    ../../tests/hawk-256-profiling/ng_hawk.c
    ../../tests/hawk-256-profiling/ng_mp31.c
    ../../tests/hawk-256-profiling/ng_ntru.c
    ../../tests/hawk-256-profiling/ng_poly.c
    ../../tests/hawk-256-profiling/ng_zint31.c
    # SHA-3 / SHAKE
    ../../tests/hawk-256-profiling/sha3.c
    # NIST API wrapper (keygen / sign / verify) for HAWK-256 (logn=8)
    ../../tests/hawk-256-profiling/api.c
    # NIST AES-256-CTR DRBG (pure-C, no OpenSSL dependency)
    ../../tests/hawk-256-profiling/rng.c
...
cflags=(
    ...
    -I../../tests/hawk-256-profiling # api.h, uart.h, test_vectors_256.h, profiling.h, hawk headers
)
