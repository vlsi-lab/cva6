...
src_main=../../tests/keccak-abs-shake256/main.c

# Companion sources (every .c except main.c, plus every .S in the test dir).
src_incs=(
    ../../tests/keccak-abs-shake256/fips202.c
    ../../tests/keccak-abs-shake256/fips202_hw.c
    ../../tests/keccak-abs-shake256/hash_coproc.S
)
