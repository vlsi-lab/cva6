...
# ---- Source files -------------------------------------------------------
src_main=../../tests/hawk-512/main.c

src_incs=(
    # HAWK core implementation
    ../../tests/hawk-512/hawk_kgen.c
    ../../tests/hawk-512/hawk_sign.c
    ../../tests/hawk-512/hawk_vrfy.c
    # NTT / polynomial helpers
    ../../tests/hawk-512/ng_fxp.c
    ../../tests/hawk-512/ng_hawk.c
    ../../tests/hawk-512/ng_mp31.c
    ../../tests/hawk-512/ng_ntru.c
    ../../tests/hawk-512/ng_poly.c
    ../../tests/hawk-512/ng_zint31.c
    # SHA-3 / SHAKE
    ../../tests/hawk-512/sha3.c
    # NIST API wrapper (keygen / sign / verify) for HAWK-512 (logn=9)
    ../../tests/hawk-512/api.c
    # NIST AES-256-CTR DRBG (pure-C, no OpenSSL dependency)
    ../../tests/hawk-512/rng.c
...
cflags=(
    ...
    -I../../tests/hawk-512      # api.h, test_vectors_512.h, hawk headers
)
