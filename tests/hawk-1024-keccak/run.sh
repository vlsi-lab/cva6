...
# ---- Source files -------------------------------------------------------
src_main=../../tests/hawk-1024-keccak/main.c

src_incs=(
    # HAWK core implementation
    ../../tests/hawk-1024-keccak/hawk_kgen.c
    ../../tests/hawk-1024-keccak/hawk_sign.c
    ../../tests/hawk-1024-keccak/hawk_vrfy.c
    # NTT / polynomial helpers
    ../../tests/hawk-1024-keccak/ng_fxp.c
    ../../tests/hawk-1024-keccak/ng_hawk.c
    ../../tests/hawk-1024-keccak/ng_mp31.c
    ../../tests/hawk-1024-keccak/ng_ntru.c
    ../../tests/hawk-1024-keccak/ng_poly.c
    ../../tests/hawk-1024-keccak/ng_zint31.c
    # SHA-3 / SHAKE (process_block offloaded to the Keccak AXI accelerator)
    ../../tests/hawk-1024-keccak/sha3.c
    # NIST API wrapper (keygen / sign / verify) for HAWK-1024 (logn=10)
    ../../tests/hawk-1024-keccak/api.c
    # NIST AES-256-CTR DRBG (pure-C, no OpenSSL dependency)
    ../../tests/hawk-1024-keccak/rng.c
)
...
cflags=(
    ...
    -I../../tests/hawk-1024-keccak      # api.h, uart.h, test_vectors_1024.h, hawk headers
