...
//
// Copied verbatim from ../keccak64/keccak_noopt.c into its own -/-opt
// directory pair (../KECCAK/ this file, ../KECCAK-opt/ = keccak_axi.c) to
// match the AES128/AES128-opt and GF2/GF2-opt naming convention -- no RTL
// changes needed here, keccak_ip already exists and is already wired into
// the SoC (see corev_apu/tb/ariane_testharness.sv).
