...
#       bare-metal-adapted falcon512_baseline.c (tools/gen_static_test.py's auto-generated
...
# ---- Source files -------------------------------------------------------
src_main=../../tests/pqc/baseline/falcon512/falcon512_baseline.c

src_incs=(
    # Falcon-512 reference implementation
    ../../tests/pqc/baseline/falcon512/codec.c
    ../../tests/pqc/baseline/falcon512/common.c
    ../../tests/pqc/baseline/falcon512/fft.c
    ../../tests/pqc/baseline/falcon512/fpr.c
    ../../tests/pqc/baseline/falcon512/keygen.c
    ../../tests/pqc/baseline/falcon512/nist.c
    ../../tests/pqc/baseline/falcon512/rng.c
    ../../tests/pqc/baseline/falcon512/shake.c
    ../../tests/pqc/baseline/falcon512/sign.c
    ../../tests/pqc/baseline/falcon512/vrfy.c
)
...
cflags=(
    ...
    -I../../tests/pqc/baseline/falcon512     # api.h, uart.h, test_vectors_512.h, inner.h, fpr.h
)
