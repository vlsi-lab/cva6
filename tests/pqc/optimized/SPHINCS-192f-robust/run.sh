#!/bin/bash
# =============================================================================
# Per-test runner for SLH-DSA optimized tests.
# =============================================================================
: "${LD_LIBRARY_PATH:=}"; export LD_LIBRARY_PATH

THIS_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
TEST_NAME="SLH-DSA-optimized-SPHINCS-192f-robust"
...
TEST_DIR=../../tests/pqc/optimized/DS/SLH-DSA/SPHINCS-192f-robust
src_main="$TEST_DIR/main.c"

src_incs=(
    "$TEST_DIR/address.c"
    "$TEST_DIR/fips202.c"
    "$TEST_DIR/fors.c"
    "$TEST_DIR/hash_shake.c"
    "$TEST_DIR/merkle.c"
    "$TEST_DIR/randombytes.c"
    "$TEST_DIR/sign.c"
    "$TEST_DIR/thash_shake_robust.c"
    "$TEST_DIR/utils.c"
    "$TEST_DIR/utilsx1.c"
    "$TEST_DIR/wots.c"
    "$TEST_DIR/wotsx1.c"
...
if [[ "optimized" == "optimized" ]]; then
    src_incs+=("$TEST_DIR/keccak_coproc.S")
fi
