...
#       bare-metal-adapted falcon1024_optimized.c (tools/gen_static_test.py's auto-generated
...
# ---- Source files -------------------------------------------------------
src_main=../../tests/pqc/optimized/falcon1024/falcon1024_optimized.c

src_incs=(
    # Falcon-1024 reference implementation
    ../../tests/pqc/optimized/falcon1024/codec.c
    ../../tests/pqc/optimized/falcon1024/common.c
    ../../tests/pqc/optimized/falcon1024/fft.c
    ../../tests/pqc/optimized/falcon1024/fpr.c
    ../../tests/pqc/optimized/falcon1024/keygen.c
    ../../tests/pqc/optimized/falcon1024/nist.c
    ../../tests/pqc/optimized/falcon1024/rng.c
    # SHA-3 / SHAKE256 (process_block offloaded to the Keccak AXI accelerator)
    ../../tests/pqc/optimized/falcon1024/shake.c
    ../../tests/pqc/optimized/falcon1024/sign.c
    ../../tests/pqc/optimized/falcon1024/vrfy.c
)
...
cflags=(
    ...
    -I../../tests/pqc/optimized/falcon1024 # api.h, uart.h, test_vectors_1024.h, inner.h, fpr.h
