...
// falcon-1024 (tools/gen_static_test.py output). stdio's printf replaced with the
// simulated UART (print_uart/print_uart_dec); cycle counting filled in via the
// RISC-V mcycle CSR (encoding.h), same
