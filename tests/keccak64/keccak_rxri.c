...
// C Benchmark for the State Permutation Function - DXROLS Implementation 
...
int main(){
    ...
    printf("KeccakF1600_StatePermute Benchmark - RXRI.L/RXRI.H Implementation\n");
