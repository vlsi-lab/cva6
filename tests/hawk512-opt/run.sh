...
# ---- Source files -------------------------------------------------------
src_main=../../tests/hawk512-opt/main.c

src_incs=(
    # HAWK core implementation
    ../../tests/hawk512-opt/hawk_kgen.c
    ../../tests/hawk512-opt/hawk_sign.c
    ../../tests/hawk512-opt/hawk_vrfy.c
    # NTT / polynomial helpers
    ../../tests/hawk512-opt/ng_fxp.c
    ../../tests/hawk512-opt/ng_hawk.c
    ../../tests/hawk512-opt/ng_mp31.c
    ../../tests/hawk512-opt/ng_ntru.c
    ../../tests/hawk512-opt/ng_poly.c
    ../../tests/hawk512-opt/ng_zint31.c
    # SHA-3 / SHAKE (process_block offloaded to the Keccak AXI accelerator)
    ../../tests/hawk512-opt/sha3.c
    # NIST API wrapper (keygen / sign / verify) for HAWK-512 (logn=9)
    ../../tests/hawk512-opt/api.c
    # NIST AES-256-CTR DRBG (pure-C, no OpenSSL dependency)
    ../../tests/hawk512-opt/rng.c
)
...
cflags=(
    ...
    -I../../tests/hawk512-opt      # api.h, uart.h, test_vectors_512.h, hawk headers
