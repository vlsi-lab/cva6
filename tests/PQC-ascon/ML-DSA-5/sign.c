                                   ...
                                   const uint8_t *sk)
{
  ...
  ascon_xof_absorb(&state, tr, TRBYTES);
  ascon_xof_absorb(&state, pre, prelen);
  ascon_xof_absorb(&state, m, mlen);
  ascon_xof_finalize(&state);
  ascon_xof_squeeze(mu, CRHBYTES, &state);

  /* Compute rhoprime = CRH(key, rnd, mu) */
  ascon_xof_init(&state);
  ascon_xof_absorb(&state, key, SEEDBYTES);
  ascon_xof_absorb(&state, rnd, RNDBYTES);
  ascon_xof_absorb(&state, mu, CRHBYTES);
  ascon_xof_finalize(&state);
  ascon_xof_squeeze(rhoprime, CRHBYTES, &state);
...
rej:
  ...
  ascon_xof_init(&state);
  ascon_xof_absorb(&state, mu, CRHBYTES);
  ascon_xof_absorb(&state, sig, K*POLYW1_PACKEDBYTES);
  ascon_xof_finalize(&state);
  ascon_xof_squeeze(sig, CTILDEBYTES, &state);
                                ...
                                const uint8_t *pk)
{
  ...
  ascon_xof_init(&state);
  ascon_xof_absorb(&state, mu, TRBYTES);
  ascon_xof_absorb(&state, pre, prelen);
  ascon_xof_absorb(&state, m, mlen);
  ascon_xof_finalize(&state);
  ascon_xof_squeeze(mu, CRHBYTES, &state);
  ...
  ascon_xof_init(&state);
  ascon_xof_absorb(&state, mu, CRHBYTES);
  ascon_xof_absorb(&state, buf, K*POLYW1_PACKEDBYTES);
  ascon_xof_finalize(&state);
  ascon_xof_squeeze(c2, CTILDEBYTES, &state);
