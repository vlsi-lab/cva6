 ...
 * 
 * Implements Kyber's symmetric primitives using Ascon-XOF
 * 
 * Mappings:
 */
...
*              Used by Kyber to sample the public matrix A.
*
...
*              Used by Kyber as the noise-sampling PRF.
*
...
*              Used by Kyber for re-encapsulation key derivation.
*
