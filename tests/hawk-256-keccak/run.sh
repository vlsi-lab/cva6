...
# ---- Source files -------------------------------------------------------
src_main=../../tests/hawk-256-keccak/main.c

src_incs=(
    # HAWK core implementation
    ../../tests/hawk-256-keccak/hawk_kgen.c
    ../../tests/hawk-256-keccak/hawk_sign.c
    ../../tests/hawk-256-keccak/hawk_vrfy.c
    # NTT / polynomial helpers
    ../../tests/hawk-256-keccak/ng_fxp.c
    ../../tests/hawk-256-keccak/ng_hawk.c
    ../../tests/hawk-256-keccak/ng_mp31.c
    ../../tests/hawk-256-keccak/ng_ntru.c
    ../../tests/hawk-256-keccak/ng_poly.c
    ../../tests/hawk-256-keccak/ng_zint31.c
    # SHA-3 / SHAKE (process_block offloaded to the Keccak AXI accelerator)
    ../../tests/hawk-256-keccak/sha3.c
    # NIST API wrapper (keygen / sign / verify) for HAWK-256 (logn=8)
    ../../tests/hawk-256-keccak/api.c
    # NIST AES-256-CTR DRBG (pure-C, no OpenSSL dependency)
    ../../tests/hawk-256-keccak/rng.c
)
...
cflags=(
    ...
    -I../../tests/hawk-256-keccak      # api.h, uart.h, test_vectors_256.h, hawk headers
