...
# ---- Source files -------------------------------------------------------
src_main=../../tests/hawk-256/main.c

src_incs=(
    # HAWK core implementation
    ../../tests/hawk-256/hawk_kgen.c
    ../../tests/hawk-256/hawk_sign.c
    ../../tests/hawk-256/hawk_vrfy.c
    # NTT / polynomial helpers
    ../../tests/hawk-256/ng_fxp.c
    ../../tests/hawk-256/ng_hawk.c
    ../../tests/hawk-256/ng_mp31.c
    ../../tests/hawk-256/ng_ntru.c
    ../../tests/hawk-256/ng_poly.c
    ../../tests/hawk-256/ng_zint31.c
    # SHA-3 / SHAKE
    ../../tests/hawk-256/sha3.c
    # NIST API wrapper (keygen / sign / verify) for HAWK-256 (logn=8)
    ../../tests/hawk-256/api.c
    # NIST AES-256-CTR DRBG (pure-C, no OpenSSL dependency)
    ../../tests/hawk-256/rng.c
...
cflags=(
    ...
    -I../../tests/hawk-256      # api.h, uart.h, test_vectors_256.h, hawk headers
)
