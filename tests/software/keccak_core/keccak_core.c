// Keccak-f[1600] permutation core benchmark, pure software.
// Adapted from tests/keccak64/keccak_noopt.c (same KAT vector), extended
// with instruction counting alongside the existing cycle counting.
...
int main(){
    ...
    printf("Keccak-f[1600] Permutation Core Benchmark - Software\n");
