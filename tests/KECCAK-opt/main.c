...
//
// Copied verbatim from ../keccak64/keccak_axi.c into its own -/-opt
// directory pair (../KECCAK/ = keccak_noopt.c, ../KECCAK-opt/ this file) to
// match the AES128/AES128-opt and GF2/GF2-opt naming convention.
