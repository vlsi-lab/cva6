...
#(
	...
	// Units instantiation
	kecc_aes_k_xif_id #(
		.copro_issue_resp_t (kecc_aes_k_xif_instr_pkg::copro_issue_resp_t),
		.opcode_t			(kecc_aes_k_xif_instr_pkg::opcode_t),
		.NbInstr			(kecc_aes_k_xif_instr_pkg::NbInstr),
		.CoproInstr			(kecc_aes_k_xif_instr_pkg::CoproInstr),
	...
	always_comb begin
		...
		// Compressed instruction offload is not used: reject any offload, always ready.
		cvxif_resp_o.compressed_resp = '0;
